...
def generate_model(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # 负面提示词，参考自https://docs.meshy.ai/prompt-guidelines
            # negative_prompt = "bad anatomy/proportions, deformed, dull, duplicate, extra arms/fingers/legs/tails, low quality, missing arms/fingers/legs, obscure, poor lighting, ugly, unnatural colors, worst quality"
            ...
            # 发送POST请求到API
            response = requests.post(api_url, json={'type': 'text_to_model', 
                                                    'prompt': prompt, 
